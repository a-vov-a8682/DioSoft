...
public class TestsForInnerUnion implements Inter_TestUtils {
    ...
    @Override
    public void test() {
        System.out.println("Running method : testInnerUnion");
    ...
    public void test_withNullLeftArray() {
        System.out.println("Running method : testInnerUnion_WithNullLeftArray");
    ...
    public void test_withNullRightArray() {
        System.out.println("Running method : testInnerUnion_WithNullRightArray");
    ...
    public void test_withEmptyLeftArray() {
        System.out.println("Running method : testInnerUnion_WithEmptyLeftArray");
    ...
    public void test_withEmptyRightArray() {
        System.out.println("Running method : testInnerUnion_WithEmptyRightArray");
